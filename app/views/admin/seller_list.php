    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 box-col-33">
        <div class="card custom-card">
          <div class="card-header"><img class="img-fluid" src="<?= BASE_URL ?>/assets/images/user-card/6.jpg" alt="">
          </div>
          <div class="card-profile"><img class="rounded-circle" src="<?= BASE_URL ?>/assets/images/avtar/3.jpg" alt="">
          </div>
