...
<body>
  ...
  <div class="container-fluid p-0">
    <div class="row m-0">
      <div class="col-xl-7 p-0"><img class="bg-img-cover bg-center" src="../../public/assets/img/bg.jpg" alt="looginpage"></div>
      <div class="col-xl-5 p-0">
        <div class="login-card" style="background: none !important; background-color: #f5f5f5 !important;">
          <div>
            <div><a class="logo text-center" href="login.php"><img class="img-fluid for-light" src="../../public/assets/img/logo.png" alt="looginpage"></a></div>
            <div class="login-main">
              <form class="theme-form">
                ...
                <p class="mt-4 mb-0 text-center">Already have an account?<a class="ms-2" href="<?= BASE_URL ?>auth/login">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
