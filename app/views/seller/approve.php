                            ...
                            <td>
                              <div class="btn-group-vertical btn-group-sm w-100">
                                ...
                                <?php elseif ($order['status'] === 'refund'): ?>
                                  ...
                                  <?php
                                  $refundedAt = !empty($order['refunded_at'])
                                  ...
                                  <?php if ($canDelete): ?>
                                    <button
                                      ...
                                      onclick="showDeleteRefundModal(<?= $order['id'] ?>)">
                                      Delete Order
                                    </button>
                                  <?php else: ?>
    ...
    <script>
      ...
      function showDeleteRefundModal(orderId) {
        document.getElementById('deleteModalTitle').innerText = 'Delete Refunded Order';
        document.getElementById('deleteMessage').innerText =
          'This order has been refunded. Are you sure you want to permanently delete it?';
