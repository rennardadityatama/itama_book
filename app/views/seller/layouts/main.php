...
<head>
    ...
    <!-- Feather (biar ga error feather is not defined) -->
...
<body>
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <?php require_once BASE_PATH . '/app/views/seller/layouts/header.php' ?>

        <div class="page-body-wrapper">
            <?php require_once BASE_PATH . '/app/views/seller/layouts/sidebar.php' ?>

            <?php require_once $content ?>

            <?php require_once BASE_PATH . '/app/views/seller/layouts/footer.php' ?>
        </div>
